package com.ray.picturebackend.infrastructure.manager.upload;
...
import com.ray.picturebackend.infrastructure.config.CosClientConfig;
...
public class FileManager {  
    ...
    private void vaildPicture(MultipartFile multipartFile) {
        ...
        ThrowUtils.throwIf(fileSize > 2 * ONE_M, ErrorCode.PARAMS_ERROR, "上传文件大小超过2M");
        // 2.校验文件后缀
    ...
    public static void deleteTempFile(File file) {
        ...
        // 删除临时文件
        boolean deleteReusult = file.delete();
        if (!deleteReusult) {
